...
public class NotesComponent extends HorizontalLayout {
    ...
    public NotesComponent(String profileImageUrl, String username, String notesImageUrl, String course, String description, LocalDateTime publishedDate) {
        setWidth("80%");
        setPadding(true);
        setSpacing(true);
        getStyle()
        ...
        leftSection.add(profileImage, usernameSpan, notesImage);
