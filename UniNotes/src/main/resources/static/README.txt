...
in /notes there are directories called with numbers, this numbers represent the ID of the FIELD OF STUDY

in /notes/{ID_FIELD_OF_STUDY} there are directories called with numbers, this numbers represent the ID of the COURSE

in /notes/{ID_FIELD_OF_STUDY}/{ID_COURSE} there are directories called with numbers, this numbers represent the ID of the USER
