...
function ca(e, t) {
    ...
    function a(s, l) {
        var c, u, d = Ge(s)[b],
            v = new Oe(l, (c = (u = n.options_) == null ? void 0 : u.enhancer) != null ? c : Se, process.env.NODE_ENV !== "production" ? d.name_ + "." + i.toString() : "ObservableObject." + i.toString(), !1);
...
var Sa = {
    ...
    }, S = /* @__PURE__ */ Yr(ci, Sa), ui = "computed", Na = "computed.struct", An = /* @__PURE__ */ jn(ui),
    xa = /* @__PURE__ */ jn(Na, {
...
var Ln = "action", qa = "action.bound", Ei = "autoAction", Ka = "autoAction.bound", Oi = "<unnamed action>",
    xn = /* @__PURE__ */ wt(Ln), Wa = /* @__PURE__ */ wt(qa, {
        bound: !0
    }), Pn = /* @__PURE__ */ wt(Ei, {
        autoAction: !0
    }), Ga = /* @__PURE__ */ wt(Ka, {
...
function xi(e, t, n) {
    ...
    var a = (r = n.name) != null ? r : process.env.NODE_ENV !== "production" ? "Reaction@" + B() : "Reaction",
        s = we(a, n.onError ? Xa(n.onError, t) : t), l = !n.scheduler && !n.delay, c = Ni(n), u = !0, d = !1, v,
        g = n.compareStructural ? ze.structural : n.equals || ze.default, m = new ee(a, function () {
            u || l ? w() : d || (d = !0, c(w));
...
var vn = /* @__PURE__ */ ii("flow"), is = /* @__PURE__ */ ii("flow.bound", {
    ...
    var r = t, i = r.name || "<unnamed flow>", o = function () {
        var s = this, l = arguments, c = ++rs, u = we(i + " - runid: " + c + " - init", r).apply(s, l), d, v = void 0,
            g = new Promise(function (m, w) {
                var N = 0;
                d = w;
...
var vs = {}, ce = "add", Ht = "delete", Ii = /* @__PURE__ */ function () {
    ...
    return t.has_ = function (r) {
        ...
        J(this.keysAtom_), re(function () {
            var c,
                u = new Oe(i, o.enhancer_, process.env.NODE_ENV !== "production" ? o.name_ + "." + wn(r) : "ObservableMap.key", !1);
...
Extending builtins is not supported.`), e;
    ...
    var r = (n = t?.name) != null ? n : process.env.NODE_ENV !== "production" ? (C(e) ? "ObservableObject" : e.constructor.name) + "@" + B() : "ObservableObject",
        i = new Cn(e, /* @__PURE__ */ new Map(), String(r), Oa(t));
    return Zt(e, b, i), e;
}
...
const Ss = Symbol.for("react.portal"), Ns = Symbol.for("react.fragment"), xs = Symbol.for("react.strict_mode"),
    Ps = Symbol.for("react.profiler"), Cs = Symbol.for("react.provider"), $s = Symbol.for("react.context"),
    zi = Symbol.for("react.forward_ref"), Ds = Symbol.for("react.suspense"), Ts = Symbol.for("react.suspense_list"),
    ks = Symbol.for("react.memo"), Is = Symbol.for("react.lazy");
...
const Hn = async (e, t, n) => window.Vaadin.copilot.comm(e, t, n), Ce = "copilot-", Ws = "24.5.9",
    Lc = "attention-required", Uc = "https://plugins.jetbrains.com/plugin/23758-vaadin",
    zc = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode";
 ...
 */
const It = globalThis,
    Kn = It.ShadowRoot && (It.ShadyCSS === void 0 || It.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype,
    Wn = Symbol(), Ar = /* @__PURE__ */ new WeakMap();
let Ji = class {
    constructor(t, n, r) {
...
const {
        ...
        getOwnPropertyNames: pl,
        getOwnPropertySymbols: gl,
        getPrototypeOf: bl
    } = Object, cn = globalThis, Nr = cn.trustedTypes, ml = Nr ? Nr.emptyScript : "",
    _l = cn.reactiveElementPolyfillSupport, lt = (e, t) => e, Dn = {
        toAttribute(e, t) {
            switch (t) {
                case Boolean:
                    e = e ? ml : null;
    ...
    _$AK(t, n) {
        ...
        if (i !== void 0 && this._$Em !== i) {
            const o = r.getPropertyOptions(i),
                a = typeof o.converter == "function" ? {fromAttribute: o.converter} : o.converter?.fromAttribute !== void 0 ? o.converter : Dn;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Gn = globalThis, Yt = Gn.trustedTypes, Cr = Yt ? Yt.createPolicy("lit-html", {createHTML: (e) => e}) : void 0,
    Yn = "$lit$", ie = `lit$${Math.random().toFixed(9).slice(2)}$`, Jn = "?" + ie, El = `<${Jn}>`, $e = document,
    gt = () => $e.createComment(""), bt = (e) => e === null || typeof e != "object" && typeof e != "function",
    Xn = Array.isArray, Zi = (e) => Xn(e) || typeof e?.[Symbol.iterator] == "function", bn = `[ 	
\f\r]`, tt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, $r = /-->/g, Dr = />/g,
    me = RegExp(`>|${bn}(?:([^\\s"'>=/]+)(${bn}*=${bn}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Tr = /'/g, kr = /"/g, Qi = /^(?:script|style|textarea|title)$/i,
    eo = (e) => (t, ...n) => ({_$litType$: e, strings: t, values: n}), ct = eo(1), Jc = eo(2),
    he = Symbol.for("lit-noChange"), O = Symbol.for("lit-nothing"), Ir = /* @__PURE__ */ new WeakMap(),
    Ee = $e.createTreeWalker($e, 129);
...
class Xe {
    ...
    $(t) {
        const {values: n, _$litType$: r} = t,
            i = typeof r == "number" ? this._$AC(t) : (r.el === void 0 && (r.el = mt.createElement(to(r.h, r.h[0]), this.options)), r);
...
const Ol = {M: Yn, P: ie, A: Jn, C: 1, L: no, R: ro, D: Zi, V: De, I: Xe, H: At, N: oo, U: ao, B: io, F: so},
    Al = Gn.litHtmlPolyfillSupport;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const lo = {ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6},
    co = (e) => (...t) => ({_$litDirective$: e, values: t});
...
const yo = () => {
    ...
    }, Wl = async () => Hn(`${Ce}get-user-info`, {}, (e) => (delete e.data.reqId, e.data)),
    Gl = async () => Hi(() => p.userInfo), ru = async () => (await Gl()).vaadiner;
...
const Lr = (e) => {
    ...
    }, tc = (e) => (e.key === "Backspace" || e.key === "Delete") && !e.shiftKey && !e.ctrlKey && !e.altKey && !e.metaKey,
    se = Xl(), iu = {
